...
function utmget(){
    ...
    if (querystring.length > 1) {
		...
		for (i in pairs) {
			...
			//Cookies.remove(keyval[0], { expires: 7, path: '/', domain: '.aenfinite.com' });
			//alert(keyval[0]);
			Cookies.set(keyval[0], keyval[1], { expires: 7, path: '/', domain: '.aenfinite.com' });
      	}
    }
	if (Cookies.get('utm_source', { domain: '.aenfinite.com' })) {
		$('input[name="utm_source"]').val(Cookies.get('utm_source', { domain: '.aenfinite.com' })); console.log(Cookies.get('utm_source', { domain: '.aenfinite.com' }));	
	}
	if (Cookies.get('utm_medium', { domain: '.aenfinite.com' })) {
		$('input[name="utm_medium"]').val(Cookies.get('utm_medium', { domain: '.aenfinite.com' })); console.log(Cookies.get('utm_medium', { domain: '.aenfinite.com' }));	
	}
	if (Cookies.get('utm_campaign', { domain: '.aenfinite.com' })) {
		$('input[name="utm_campaign"]').val(Cookies.get('utm_campaign', { domain: '.aenfinite.com' })); console.log(Cookies.get('utm_campaign', { domain: '.aenfinite.com' }));	
	}
	if (Cookies.get('utm_id', { domain: '.aenfinite.com' })) {
		$('input[name="utm_id"]').val(Cookies.get('utm_id', { domain: '.aenfinite.com' })); console.log(Cookies.get('utm_id', { domain: '.aenfinite.com' }));	
	}
	if (Cookies.get('utm_content', { domain: '.aenfinite.com' })) {
		$('input[name="utm_content"]').val(Cookies.get('utm_content', { domain: '.aenfinite.com' })); console.log(Cookies.get('utm_content', { domain: '.aenfinite.com' }));	
	}
	if (Cookies.get('utm_term', { domain: '.aenfinite.com' })) {
		$('input[name="utm_term"]').val(Cookies.get('utm_term', { domain: '.aenfinite.com' })); console.log(Cookies.get('utm_term', { domain: '.aenfinite.com' }));	
	}
	if (Cookies.get('utm_id', { domain: '.aenfinite.com' })) {
		$('input[name="utm_id"]').val(Cookies.get('utm_id', { domain: '.aenfinite.com' })); console.log(Cookies.get('utm_id', { domain: '.aenfinite.com' }));	
	}
...
window.addEventListener('blur', function() {
    document.title = 'Aenfinite misses you!';
},false);
